    ...
    <form onSubmit={handleSubmit} className={`flex items-center ${className}`}>
      <div className={`relative flex items-center ${width}`}>
        <input
          ...
          className="w-full px-4 py-1.5 text-sm bg-white rounded-full border-2 transition-colors duration-100 border-solid outline-none focus:border-[#b5b4f2] border-[#9a9a9a]"
